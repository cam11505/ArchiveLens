...
python scripts/verify_release.py dist/release/ArchiveLens-1.2.2-windows-x64.zip --run
python scripts/build_installer.py --iscc outputs/inno/ISCC.exe
python scripts/verify_installer.py dist/release/ArchiveLens-1.2.2-setup-x64.exe
